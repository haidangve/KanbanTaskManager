...
function TaskCard({ task, deleteTask, updateTask }: Props) {
  ...
  if(isDragging){
    ...
    className="bg-mainBackgroundColor p-2.5 h-[100px] min-h-[100px] 
        ...
        cursor-grabs relative opacity-50"/>
  }
  ...
  if (editMode)
    return (
      ...
      >
        <textarea
          className="
        h-[90p%] w-full resize-none border-none rounded bg-transparent
    ...
    >
      ...
      {mouseIsOver && (
        <button
          ...
          className="stroke-white absolute right-4 top-1/2 -translate-y-1/2 bg-columnBackgroundColor
